...
import './ConciliacaoVendasPendentes.css';

const ConciliacaoVendasPendentes = () => {
    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#f5f5f5' }}>
      ...
      <Container fluid style={{ marginLeft: '250px', padding: '20px' }}>
        <div className="d-flex justify-content-between align-items-center mb-4">
          <h2 className="text-danger">Conciliação Vendas Pendentes</h2>
...
export default ConciliacaoVendasPendentes;
